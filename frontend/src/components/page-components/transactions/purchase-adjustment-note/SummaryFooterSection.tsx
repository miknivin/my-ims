...
export default function SummaryFooterSection() {
  const { inventoryEffectLabel, state, setGeneral, setFooter } =
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="lg:col-span-2">
            ...
            <textarea
              ...
              placeholder="Vendor claim context, return notes, or pricing explanation..."
            />
          </div>
          ...
          <div className="rounded-xl border border-dashed border-gray-300 px-4 py-3 text-sm text-gray-500 dark:border-gray-700 dark:text-gray-400">
            Current inventory effect: {inventoryEffectLabel}
          </div>
      ...
      content: (
        <div>
          ...
          <textarea
            ...
            placeholder="Additional purchase adjustment note remarks..."
          />
        </div>
      ),
    },
