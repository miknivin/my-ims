...
import {
  SALES_ADJUSTMENT_NOTE_LINE_COLUMNS,
  SalesAdjustmentNoteLineColumnKey,
  SalesAdjustmentNoteLineColumnMeta,
} from "../lineItemColumns";
import { SalesAdjustmentNoteLineState } from "../types/types";

export interface SalesAdjustmentNoteLineColumnRenderContext {
...
export interface SalesAdjustmentNoteLineColumnDefinition
  extends TransactionLineColumnDefinition<
      SalesAdjustmentNoteLineState,
      SalesAdjustmentNoteLineColumnRenderContext,
      SalesAdjustmentNoteLineColumnKey
    >,
    SalesAdjustmentNoteLineColumnMeta {
  sortable: boolean;
  getSortValue: (line: SalesAdjustmentNoteLineState) => string | number;
  renderCell: (context: SalesAdjustmentNoteLineColumnRenderContext) => ReactNode;
}
...
export function useSalesAdjustmentNoteLineColumns() {
  return useMemo<SalesAdjustmentNoteLineColumnDefinition[]>(() => {
    const sortAccessors: Record<
      SalesAdjustmentNoteLineColumnKey,
      (line: SalesAdjustmentNoteLineState) => string | number
    > = {
    ...
    const renderers: Record<
      SalesAdjustmentNoteLineColumnKey,
      SalesAdjustmentNoteLineColumnDefinition["renderCell"]
    > = {
    ...
    return SALES_ADJUSTMENT_NOTE_LINE_COLUMNS.map((column) => ({
      ...column,
      sortable: true,
