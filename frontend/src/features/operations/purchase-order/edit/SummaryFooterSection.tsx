...
export default function SummaryFooterSection() {
  const { state, setFooter } = usePurchaseOrderEditForm();
  ...
  const metrics: TransactionSummaryMetric[] = [
    { key: "total", label: "Total", value: state.footer.total.toFixed(2) },
    { key: "discount", label: "Discount", value: state.footer.discount.toFixed(2) },
    { key: "tax", label: "Tax", value: state.footer.tax.toFixed(2) },
    { key: "additions", label: "Additions", value: state.footer.addition.toFixed(2) },
    { key: "advance", label: "Advance", value: advance.toFixed(2) },
