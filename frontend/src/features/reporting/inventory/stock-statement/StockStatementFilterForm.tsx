...
export interface StockStatementFilterValues {
...
interface Props {
  values: StockStatementFilterValues;
  categories: Category[];
  warehouses: Warehouse[];
  onChange: (v: Partial<StockStatementFilterValues>) => void;
  onApply: () => void;
  onClear: () => void;
}
...
export default function StockStatementFilterForm({
  values,
  categories,
  warehouses,
  onChange,
