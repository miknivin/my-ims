...
export interface InventoryValuationFilterValues {
  categoryId: string;
  warehouseId: string;
...
interface Props {
  ...
  onChange: (v: Partial<InventoryValuationFilterValues>) => void;
  onApply: () => void;
  onClear: () => void;
}
...
export default function InventoryValuationFilterForm({
  values,
  categories,
  warehouses,
  onChange,
