...
public sealed record GoodsReceiptNoteLogisticsRequest(string? LrService, string? LrNo, DateOnly? LrDate, string? EWayBillNo);
...
public sealed record UpdateGoodsReceiptNoteStatusRequest(string? Status);
