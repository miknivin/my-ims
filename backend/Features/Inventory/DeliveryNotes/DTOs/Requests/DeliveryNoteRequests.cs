...
public sealed record DeliveryNoteLogisticsRequest(string? TransportMode, string? LrNo, DateOnly? LrDate, string? VehicleNo, string? EWayBillNo, string? TransporterName);
