...
public sealed class PurchaseDebitNoteLineItemConfiguration : IEntityTypeConfiguration<PurchaseDebitNoteLineItem>
{
    public void Configure(EntityTypeBuilder<PurchaseDebitNoteLineItem> builder)
    {
        builder.ToTable("purchase_debit_note_lines");
