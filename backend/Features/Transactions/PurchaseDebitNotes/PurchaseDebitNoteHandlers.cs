...
internal static class PurchaseDebitNoteHandlers
{
    ...
    internal static async Task<IResult> CreateAsync(CreatePurchaseDebitNoteRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
