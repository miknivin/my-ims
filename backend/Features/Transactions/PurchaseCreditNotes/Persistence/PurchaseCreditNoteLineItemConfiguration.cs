...
namespace backend.Features.Transactions.PurchaseCreditNotes.Persistence;

public sealed class PurchaseCreditNoteLineItemConfiguration : IEntityTypeConfiguration<PurchaseCreditNoteLineItem>
{
    public void Configure(EntityTypeBuilder<PurchaseCreditNoteLineItem> builder)
    {
        builder.ToTable("purchase_credit_note_lines");
