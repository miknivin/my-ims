...
public sealed class SalesInvoiceLineItemConfiguration : IEntityTypeConfiguration<SalesInvoiceLineItem>
{
    public void Configure(EntityTypeBuilder<SalesInvoiceLineItem> builder)
    {
