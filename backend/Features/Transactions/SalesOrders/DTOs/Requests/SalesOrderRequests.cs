...
public sealed record UpdateSalesOrderRequest(SalesOrderOrderDetailsRequest OrderDetails, SalesOrderPartyInformationRequest PartyInformation, SalesOrderCommercialDetailsRequest CommercialDetails, SalesOrderSalesDetailsRequest SalesDetails, IReadOnlyList<SalesOrderLineItemRequest> Items, IReadOnlyList<SalesOrderAdditionRequest> Additions, SalesOrderFooterRequest Footer, string? Status);
