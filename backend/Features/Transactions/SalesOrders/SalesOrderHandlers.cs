...
internal static class SalesOrderHandlers
{
    ...
    internal static async Task<IResult> CreateAsync(CreateSalesOrderRequest request, ClaimsPrincipal principal, AppDbContext dbContext, CancellationToken cancellationToken)
    {
