...
public sealed record UpdateSalesCreditNoteRequest(string NoteNature, SalesCreditNoteSourceReferenceRequest SourceRef, SalesCreditNoteDocumentRequest Document, SalesCreditNoteCustomerInformationRequest CustomerInformation, SalesCreditNoteFinancialDetailsRequest FinancialDetails, SalesCreditNoteGeneralRequest General, IReadOnlyList<SalesCreditNoteLineItemRequest> Items, IReadOnlyList<SalesCreditNoteAdditionRequest> Additions, SalesCreditNoteFooterRequest Footer, string? Status);
