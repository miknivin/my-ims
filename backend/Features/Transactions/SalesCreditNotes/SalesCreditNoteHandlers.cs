...
internal static class SalesCreditNoteHandlers
{
    ...
    internal static async Task<IResult> CreateAsync(CreateSalesCreditNoteRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
