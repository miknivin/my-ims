...
public sealed class SalesDebitNoteLineItemConfiguration : IEntityTypeConfiguration<SalesDebitNoteLineItem>
{
    public void Configure(EntityTypeBuilder<SalesDebitNoteLineItem> builder)
    {
        builder.ToTable("sales_debit_note_lines");
