...
internal static class SalesDebitNoteHandlers
{
    ...
    internal static async Task<IResult> CreateAsync(CreateSalesDebitNoteRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
