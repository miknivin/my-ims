...
internal static class PurchaseOrderHandlers
{
    ...
    internal static async Task<IResult> CreateAsync(CreatePurchaseOrderRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
