...
internal static class WarehouseHandlers
{
    ...
    internal static async Task<IResult> CreateAsync(CreateWarehouseRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    internal static async Task<IResult> UpdateAsync(Guid id, UpdateWarehouseRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
        var buildResult = BuildWarehouseRequest(request.Code, request.Name, request.Status, request.ContactPerson, request.Phone, request.Email, request.Address);
        if (buildResult.Error is not null)
        {
