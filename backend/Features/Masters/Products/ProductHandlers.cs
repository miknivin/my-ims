...
internal static class ProductHandlers
{
    ...
    internal static async Task<IResult> GetAllAsync([AsParameters] ProductFilterRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    internal static async Task<IResult> CreateAsync(CreateProductRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    internal static async Task<IResult> UpdateAsync(Guid id, UpdateProductRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
        var buildResult = BuildProductRequest(
            request.BasicInfo,
            request.PricingAndRates,
