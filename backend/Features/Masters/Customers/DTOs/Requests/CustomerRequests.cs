...
public sealed record CreateCustomerRequest(CustomerBasicDetailsRequest BasicDetails, Guid LedgerGroupId, CustomerContactRequest Contact, CustomerBillingAddressRequest BillingAddress, List<CustomerShippingAddressRequest> ShippingAddresses, List<CustomerTaxDocumentRequest> TaxDocuments, CustomerFinancialsRequest Financials, CustomerSalesAndPricingRequest SalesAndPricing, CustomerStatusDetailsRequest StatusDetails, string? Status, CustomerOpeningBalanceRequest? OpeningBalance);
public sealed record UpdateCustomerRequest(CustomerBasicDetailsRequest BasicDetails, Guid LedgerGroupId, CustomerContactRequest Contact, CustomerBillingAddressRequest BillingAddress, List<CustomerShippingAddressRequest> ShippingAddresses, List<CustomerTaxDocumentRequest> TaxDocuments, CustomerFinancialsRequest Financials, CustomerSalesAndPricingRequest SalesAndPricing, CustomerStatusDetailsRequest StatusDetails, string? Status, CustomerOpeningBalanceRequest? OpeningBalance);
