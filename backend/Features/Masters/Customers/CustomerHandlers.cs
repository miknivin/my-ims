...
internal static class CustomerHandlers
{
    ...
    internal static async Task<IResult> GetAllAsync([AsParameters] CustomerFilterRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    internal static async Task<IResult> CreateAsync(CreateCustomerRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    internal static async Task<IResult> UpdateAsync(Guid id, UpdateCustomerRequest request, AppDbContext dbContext, CancellationToken cancellationToken)
    {
        var buildResult = BuildCustomerRequest(
            request.BasicDetails,
            request.Contact,
