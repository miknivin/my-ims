    ...
    DateTime UpdatedAtUtc)
{
    public static VendorDto FromEntity(Vendor vendor)
    {
        return new VendorDto(
            ...
            vendor.LedgerId ?? Guid.Empty,
            vendor.Ledger?.Code ?? string.Empty,
            vendor.Ledger?.Name ?? string.Empty,
            vendor.Ledger?.LedgerGroupId ?? Guid.Empty,
            vendor.Ledger?.LedgerGroup?.Name,
